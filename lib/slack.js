...
class Slack extends webhook_1.IncomingWebhook {
     ...
     */
    generatePayload(status, job_name) {
        const text = `${job_name} ${Slack.result[status]} ${Slack.mark[status]}`;
        const attachments = {
     ...
     */
    notify(status, job_name) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const payload = this.generatePayload(status, job_name);
...
Slack.result = ['Failed', 'Succeeded', 'Canceled'];
exports.Slack = Slack;
